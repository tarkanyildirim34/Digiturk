...
using Digiturk.Core;
using Digiturk.Data.Mapping;

namespace Digiturk.Data
{
    /// <summary>
    /// Represents base object context
    /// </summary>
    public partial class DigiturkObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public DigiturkObjectContext(DbContextOptions<DigiturkObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var typeConfigurations = Assembly.GetExecutingAssembly().GetTypes().Where(type =>
                (type.BaseType?.IsGenericType ?? false)
                    && (type.BaseType.GetGenericTypeDefinition() == typeof(DigiturkEntityTypeConfiguration<>)
                        || type.BaseType.GetGenericTypeDefinition() == typeof(DigiturkQueryTypeConfiguration<>)));
